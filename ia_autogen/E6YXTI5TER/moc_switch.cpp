...
#include "include/app/widgets/switch.hpp"
...
QT_MOC_LITERAL(4, 27, 11), // "track_color"
QT_MOC_LITERAL(5, 39, 11), // "thumb_color"
QT_MOC_LITERAL(6, 51, 6) // "offset"

    },
    "Switch\0stateChanged\0\0state\0track_color\0"
    "thumb_color\0offset"
};
...
void Switch::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QColor*>(_v) = _t->get_track_color(); break;
        case 1: *reinterpret_cast< QColor*>(_v) = _t->get_thumb_color(); break;
        case 2: *reinterpret_cast< int*>(_v) = _t->get_offset(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->set_track_color(*reinterpret_cast< QColor*>(_v)); break;
        case 1: _t->set_thumb_color(*reinterpret_cast< QColor*>(_v)); break;
        case 2: _t->set_offset(*reinterpret_cast< int*>(_v)); break;
        default: break;
        }
...
// SIGNAL 0
void Switch::stateChanged(bool _t1)
{
