...
class WindowManager : QObject {
 ...
 signals:
  ...
  void OnCreateSignal(const XCreateWindowEvent& e);
  void OnDestroySignal(const XDestroyWindowEvent& e);
  void OnReparentSignal(const XReparentEvent& e);
  void OnMapSignal(const XMapEvent& e);
  void OnUnmapSignal(const XUnmapEvent& e);
