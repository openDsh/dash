...
Session::Layout::Layout(QSettings &settings, Arbiter &arbiter)
    ...
    , fullscreen_mode(settings.value("Layout/FullscreenMode/Enabled", false).toBool())
    , fullscreen_delay(settings.value("Layout/FullscreenMode/Delay", 1000).toInt())
    , fullscreen_acknowledged(settings.value("Layout/FullscreenMode/Acknowledged", false).toBool())
